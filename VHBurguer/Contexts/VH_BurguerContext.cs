...
public partial class VH_BurguerContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=VH_Burguer;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.CategoriaID).HasName("PK__Categori__F353C1C580DF32F0");
        ...
        {
            entity.HasKey(e => e.Log_AlteracaoProdutoID).HasName("PK__Log_Alte__D06C51B760F8F2B6");
            ...
            entity.HasOne(d => d.Produto).WithMany(p => p.Log_AlteracaoProduto)
                ...
                .HasConstraintName("FK__Log_Alter__Produ__6E01572D");
        });

        modelBuilder.Entity<Produto>(entity =>
        {
            entity.HasKey(e => e.ProdutoID).HasName("PK__Produto__9C8800C3AF6615D3");
            ...
            entity.HasIndex(e => e.Nome, "UQ__Produto__7D8FE3B2B193F750").IsUnique();
        ...
        {
            entity.HasKey(e => e.PromocaoID).HasName("PK__Promocao__254B583DECA832D6");
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE798609A23BD");

            entity.ToTable(tb => tb.HasTrigger("trg_ExclusaoUsuario"));

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D105346D093ED8").IsUnique();
